...
class NormalizeResponseRequestsInnerResponseItemsInnerMetadataMappingsRxnormCodesInnerRxnormTitlesInner(ModelNormal):
    ...
    attribute_map = {
        ...
        'title_type': 'title_type',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NormalizeResponseRequestsInnerResponseItemsInnerMetadataMappingsRxnormCodesInnerRxnormTitlesInner - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            title (str): An RxNorm title for rxnorm_code. [optional]  # noqa: E501
            title_type (str): The RxNorm term type (TTY) for title. [optional]  # noqa: E501
            title_status (str): Indicates if the title is 'current' and in the current RxNorm release or 'historical' and no longer included in the current RxNorm release. [optional]  # noqa: E501
        """
