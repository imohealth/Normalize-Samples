...
from normalizeapiclient import rest
from normalizeapiclient.configuration import Configuration
from normalizeapiclient.exceptions import ApiTypeError, ApiValueError, ApiException
from normalizeapiclient.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = NormalizeApi()
        api_instance.normalize  # this is an instance of the class Endpoint
        api_instance.normalize()  # this invokes api_instance.normalize.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.normalize.callable or self.callable in this class
