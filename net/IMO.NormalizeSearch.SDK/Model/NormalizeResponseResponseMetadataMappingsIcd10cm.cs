...
{
    /// <summary>
    /// NormalizeResponseResponseMetadataMappingsIcd10cm
    /// </summary>
    [DataContract]
    public partial class NormalizeResponseResponseMetadataMappingsIcd10cm :  IEquatable<NormalizeResponseResponseMetadataMappingsIcd10cm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NormalizeResponseResponseMetadataMappingsIcd10cm" /> class.
        /// </summary>
        ...
        public NormalizeResponseResponseMetadataMappingsIcd10cm(List<NormalizeResponseResponseMetadataMappingsIcd10cmCodes> codes = default(List<NormalizeResponseResponseMetadataMappingsIcd10cmCodes>), string mapContext = default(string))
        {
            this.Codes = codes;
        ...
        public List<NormalizeResponseResponseMetadataMappingsIcd10cmCodes> Codes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NormalizeResponseResponseMetadataMappingsIcd10cm {\n");
        ...
        {
            return this.Equals(input as NormalizeResponseResponseMetadataMappingsIcd10cm);
        }

        /// <summary>
        /// Returns true if NormalizeResponseResponseMetadataMappingsIcd10cm instances are equal
        /// </summary>
        /// <param name="input">Instance of NormalizeResponseResponseMetadataMappingsIcd10cm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NormalizeResponseResponseMetadataMappingsIcd10cm input)
        {
            if (input == null)
                return false;
