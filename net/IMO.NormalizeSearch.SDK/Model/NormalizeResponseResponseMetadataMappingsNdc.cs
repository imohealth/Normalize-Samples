...
{
    /// <summary>
    /// NormalizeResponseResponseMetadataMappingsNdc
    /// </summary>
    [DataContract]
    public partial class NormalizeResponseResponseMetadataMappingsNdc :  IEquatable<NormalizeResponseResponseMetadataMappingsNdc>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NormalizeResponseResponseMetadataMappingsNdc" /> class.
        /// </summary>
        ...
        public NormalizeResponseResponseMetadataMappingsNdc(List<NormalizeResponseResponseMetadataMappingsNdcCodes> codes = default(List<NormalizeResponseResponseMetadataMappingsNdcCodes>), string mapContext = default(string))
        {
            this.Codes = codes;
        ...
        public List<NormalizeResponseResponseMetadataMappingsNdcCodes> Codes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NormalizeResponseResponseMetadataMappingsNdc {\n");
        ...
        {
            return this.Equals(input as NormalizeResponseResponseMetadataMappingsNdc);
        }

        /// <summary>
        /// Returns true if NormalizeResponseResponseMetadataMappingsNdc instances are equal
        /// </summary>
        /// <param name="input">Instance of NormalizeResponseResponseMetadataMappingsNdc to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NormalizeResponseResponseMetadataMappingsNdc input)
        {
            if (input == null)
                return false;
