...
{
    /// <summary>
    /// NormalizeResponseResponseMetadataMappingsIcd10cmCodes
    /// </summary>
    [DataContract]
    public partial class NormalizeResponseResponseMetadataMappingsIcd10cmCodes :  IEquatable<NormalizeResponseResponseMetadataMappingsIcd10cmCodes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NormalizeResponseResponseMetadataMappingsIcd10cmCodes" /> class.
        /// </summary>
        /// <param name="code">A ICD-10-CM code mapped to the IMO lexical.</param>
        /// <param name="title">The official description of the ICD-10-CM code.</param>
        ...
        public NormalizeResponseResponseMetadataMappingsIcd10cmCodes(string code = default(string), string title = default(string), string mapType = default(string), NormalizeResponseResponseMetadataMappingsIcd10cmCodeMetadata codeMetadata = default(NormalizeResponseResponseMetadataMappingsIcd10cmCodeMetadata))
        {
            this.Code = code;
            this.Title = title;
        ...
        /// <summary>
        /// A ICD-10-CM code mapped to the IMO lexical
        /// </summary>
        /// <value>A ICD-10-CM code mapped to the IMO lexical</value>
        [DataMember(Name="code", EmitDefaultValue=false)]
        public string Code { get; set; }

        /// <summary>
        /// The official description of the ICD-10-CM code
        /// </summary>
        /// <value>The official description of the ICD-10-CM code</value>
        ...
        public NormalizeResponseResponseMetadataMappingsIcd10cmCodeMetadata CodeMetadata { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NormalizeResponseResponseMetadataMappingsIcd10cmCodes {\n");
        ...
        {
            return this.Equals(input as NormalizeResponseResponseMetadataMappingsIcd10cmCodes);
        }

        /// <summary>
        /// Returns true if NormalizeResponseResponseMetadataMappingsIcd10cmCodes instances are equal
        /// </summary>
        /// <param name="input">Instance of NormalizeResponseResponseMetadataMappingsIcd10cmCodes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NormalizeResponseResponseMetadataMappingsIcd10cmCodes input)
        {
            if (input == null)
                return false;
