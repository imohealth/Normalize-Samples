...
{
    /// <summary>
    /// NormalizeResponseResponseMetadataMappingsSnomedInternational
    /// </summary>
    [DataContract]
    public partial class NormalizeResponseResponseMetadataMappingsSnomedInternational :  IEquatable<NormalizeResponseResponseMetadataMappingsSnomedInternational>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NormalizeResponseResponseMetadataMappingsSnomedInternational" /> class.
        /// </summary>
        ...
        public NormalizeResponseResponseMetadataMappingsSnomedInternational(List<NormalizeResponseResponseMetadataMappingsSnomedInternationalCodes> codes = default(List<NormalizeResponseResponseMetadataMappingsSnomedInternationalCodes>), string mapContext = default(string))
        {
            this.Codes = codes;
        ...
        public List<NormalizeResponseResponseMetadataMappingsSnomedInternationalCodes> Codes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NormalizeResponseResponseMetadataMappingsSnomedInternational {\n");
        ...
        {
            return this.Equals(input as NormalizeResponseResponseMetadataMappingsSnomedInternational);
        }

        /// <summary>
        /// Returns true if NormalizeResponseResponseMetadataMappingsSnomedInternational instances are equal
        /// </summary>
        /// <param name="input">Instance of NormalizeResponseResponseMetadataMappingsSnomedInternational to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NormalizeResponseResponseMetadataMappingsSnomedInternational input)
        {
            if (input == null)
                return false;
