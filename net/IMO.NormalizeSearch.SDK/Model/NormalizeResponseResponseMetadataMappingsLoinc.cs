...
{
    /// <summary>
    /// NormalizeResponseResponseMetadataMappingsLoinc
    /// </summary>
    [DataContract]
    public partial class NormalizeResponseResponseMetadataMappingsLoinc :  IEquatable<NormalizeResponseResponseMetadataMappingsLoinc>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NormalizeResponseResponseMetadataMappingsLoinc" /> class.
        /// </summary>
        ...
        public NormalizeResponseResponseMetadataMappingsLoinc(List<NormalizeResponseResponseMetadataMappingsLoincCodes> codes = default(List<NormalizeResponseResponseMetadataMappingsLoincCodes>), string mapContext = default(string))
        {
            this.Codes = codes;
        ...
        public List<NormalizeResponseResponseMetadataMappingsLoincCodes> Codes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NormalizeResponseResponseMetadataMappingsLoinc {\n");
        ...
        {
            return this.Equals(input as NormalizeResponseResponseMetadataMappingsLoinc);
        }

        /// <summary>
        /// Returns true if NormalizeResponseResponseMetadataMappingsLoinc instances are equal
        /// </summary>
        /// <param name="input">Instance of NormalizeResponseResponseMetadataMappingsLoinc to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NormalizeResponseResponseMetadataMappingsLoinc input)
        {
            if (input == null)
                return false;
