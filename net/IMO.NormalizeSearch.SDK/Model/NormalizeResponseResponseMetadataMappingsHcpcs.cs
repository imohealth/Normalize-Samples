...
{
    /// <summary>
    /// NormalizeResponseResponseMetadataMappingsHcpcs
    /// </summary>
    [DataContract]
    public partial class NormalizeResponseResponseMetadataMappingsHcpcs :  IEquatable<NormalizeResponseResponseMetadataMappingsHcpcs>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NormalizeResponseResponseMetadataMappingsHcpcs" /> class.
        /// </summary>
        ...
        public NormalizeResponseResponseMetadataMappingsHcpcs(List<NormalizeResponseResponseMetadataMappingsHcpcsCodes> codes = default(List<NormalizeResponseResponseMetadataMappingsHcpcsCodes>), string mapContext = default(string))
        {
            this.Codes = codes;
        ...
        public List<NormalizeResponseResponseMetadataMappingsHcpcsCodes> Codes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NormalizeResponseResponseMetadataMappingsHcpcs {\n");
        ...
        {
            return this.Equals(input as NormalizeResponseResponseMetadataMappingsHcpcs);
        }

        /// <summary>
        /// Returns true if NormalizeResponseResponseMetadataMappingsHcpcs instances are equal
        /// </summary>
        /// <param name="input">Instance of NormalizeResponseResponseMetadataMappingsHcpcs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NormalizeResponseResponseMetadataMappingsHcpcs input)
        {
            if (input == null)
                return false;
