...
{
    /// <summary>
    /// NormalizeResponseResponseMetadataMappingsCpt
    /// </summary>
    [DataContract]
    public partial class NormalizeResponseResponseMetadataMappingsCpt :  IEquatable<NormalizeResponseResponseMetadataMappingsCpt>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NormalizeResponseResponseMetadataMappingsCpt" /> class.
        /// </summary>
        ...
        public NormalizeResponseResponseMetadataMappingsCpt(List<NormalizeResponseResponseMetadataMappingsCptCodes> codes = default(List<NormalizeResponseResponseMetadataMappingsCptCodes>), string mapContext = default(string))
        {
            this.Codes = codes;
        ...
        public List<NormalizeResponseResponseMetadataMappingsCptCodes> Codes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NormalizeResponseResponseMetadataMappingsCpt {\n");
        ...
        {
            return this.Equals(input as NormalizeResponseResponseMetadataMappingsCpt);
        }

        /// <summary>
        /// Returns true if NormalizeResponseResponseMetadataMappingsCpt instances are equal
        /// </summary>
        /// <param name="input">Instance of NormalizeResponseResponseMetadataMappingsCpt to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NormalizeResponseResponseMetadataMappingsCpt input)
        {
            if (input == null)
                return false;
