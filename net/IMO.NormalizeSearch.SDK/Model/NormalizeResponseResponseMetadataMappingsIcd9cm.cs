...
{
    /// <summary>
    /// NormalizeResponseResponseMetadataMappingsIcd9cm
    /// </summary>
    [DataContract]
    public partial class NormalizeResponseResponseMetadataMappingsIcd9cm :  IEquatable<NormalizeResponseResponseMetadataMappingsIcd9cm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NormalizeResponseResponseMetadataMappingsIcd9cm" /> class.
        /// </summary>
        ...
        public NormalizeResponseResponseMetadataMappingsIcd9cm(List<NormalizeResponseResponseMetadataMappingsIcd9cmCodes> codes = default(List<NormalizeResponseResponseMetadataMappingsIcd9cmCodes>), string mapContext = default(string))
        {
            this.Codes = codes;
        ...
        public List<NormalizeResponseResponseMetadataMappingsIcd9cmCodes> Codes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NormalizeResponseResponseMetadataMappingsIcd9cm {\n");
        ...
        {
            return this.Equals(input as NormalizeResponseResponseMetadataMappingsIcd9cm);
        }

        /// <summary>
        /// Returns true if NormalizeResponseResponseMetadataMappingsIcd9cm instances are equal
        /// </summary>
        /// <param name="input">Instance of NormalizeResponseResponseMetadataMappingsIcd9cm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NormalizeResponseResponseMetadataMappingsIcd9cm input)
        {
            if (input == null)
                return false;
