...
namespace IMO.NormalizeSearch.SDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NormalizeResponseResponseMetadataMappingsRxnorm :  IEquatable<NormalizeResponseResponseMetadataMappingsRxnorm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NormalizeResponseResponseMetadataMappingsRxnorm" /> class.
        /// </summary>
        ...
        public NormalizeResponseResponseMetadataMappingsRxnorm(List<NormalizeResponseResponseMetadataMappingsRxnormCodes> codes = default(List<NormalizeResponseResponseMetadataMappingsRxnormCodes>), string mapContext = default(string))
        {
            this.Codes = codes;
        ...
        public List<NormalizeResponseResponseMetadataMappingsRxnormCodes> Codes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NormalizeResponseResponseMetadataMappingsRxnorm {\n");
        ...
        {
            return this.Equals(input as NormalizeResponseResponseMetadataMappingsRxnorm);
        }

        /// <summary>
        /// Returns true if NormalizeResponseResponseMetadataMappingsRxnorm instances are equal
        /// </summary>
        /// <param name="input">Instance of NormalizeResponseResponseMetadataMappingsRxnorm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NormalizeResponseResponseMetadataMappingsRxnorm input)
        {
            if (input == null)
                return false;
