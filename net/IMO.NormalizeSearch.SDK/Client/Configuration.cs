...
namespace IMO.NormalizeSearch.SDK.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        /// and need to be manually reverted. The modification was to account for null and 0 status responses.
        /// There is an open bug ticket for OpenAPI Generator to address this here:
        /// https://github.com/OpenAPITools/openapi-generator/issues/8732
        /// </remarks>
        public static readonly ExceptionFactory DefaultExceptionFactory = (methodName, response) =>
        {
            if (response == null)
            {
                return new ApiException(-1, $"Error calling {methodName}: response is null");
            }
        ...
        public Configuration()
        {
            ...
            BasePath = "https://api-sandbox.imohealth.com";
        ...
        public Configuration(
            ...
            string basePath = "https://api-sandbox.imohealth.com") : this()
        {
        ...
        {
            String report = "C# SDK (IMO.NormalizeSearch.SDK) Debug Report:\n";
